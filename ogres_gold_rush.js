...
this.getCalculatedValue = function(all_items, the_enemy) {
    ...
    for(var i = 0; i < all_items.length; ++i) {
        ...
        var item_value = (item.bountyGold * 5) - this.getDistanceTo(item.pos.x, item.pos.y) * 2 + this.getDistanceBetween(item.pos.x, item.pos.y, the_enemy.pos.x, the_enemy.pos.y) / 2;
